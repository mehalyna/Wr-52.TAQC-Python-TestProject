...
from src.webElements.InputElement import InputElement
...
class ModalPage(BaseWrapper):
    ...
    def login(self, username: str, password: str) -> None:
        ...
        self.sign_in_up_clear_btns.click_btn_by_name_by_xpath(self.SIGN_IN_BUTTON_TEXT)

    def registration(self, username: str, password: str) -> None:
        """Registration method as a scenario
        actor - is a person with own permissions (admin or user).
        :param username: username
        :param password: pass phrase
        """
        self.page_btns.click_btn_by_name_by_xpath(self.FORM_PAGE_REGISTER_TEXT)
        self.email_inp.send_data_by_xpath(username)
        self.pass_inp.send_data_by_xpath(password)
        self.pass_repeat_inp.send_data_by_xpath(password)
        self.sign_in_up_clear_btns.click_btn_by_name_by_xpath(self.FORM_PAGE_BUTTON_SING_UP_TEXT)
